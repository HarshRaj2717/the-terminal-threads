...
class ImageHandler:
    ...
    def encode_image(self, secret_image_path, mask_image_path, bit_count = 4,key = 0) -> None:
        """Encodes image"""
        ...
        encoded_image_array = encrypt_frame(mask_image_ndarray, secret_image_ndarray, self.secret_key, bit_count)
    ...
    def decode_image(self, image_path) -> None:
        ...
        decoded_image.save("samples/decrypted.png")
